...
import { IFilm, IFilms } from '@features/films/components/films-list/model/films.interface';
import { TextComponent } from '@app/components/login/form/text/text.component';
import { FilmListComponent } from '@app/components/films/film-list/film-list.component';
