...
export class PasswordComponent implements ControlValueAccessor {
  ...
  objectForControlsPassword = input<FormControl<string | null>>(new FormControl<string | null>(''));
  mainFieldPassword = input<string>('');
  ...
  public eventStarted(event: Event): void {
    ...
    const objectErorrs: ValidationErrors | null = this.objectForControlsPassword().errors;
  ...
  public handle(event: Event, input: HTMLInputElement): void {
    ...
    const basePath: string = '../../../../../assets/img/sprite.svg#';
